...
namespace g2::gfx
{
    ...
    static QueueFamilyIndices findQueueFamilies(const vk::PhysicalDevice physicalDevice, vk::SurfaceKHR surface)
    {
    ...
    static bool checkDeviceExtensionSupport(vk::PhysicalDevice device)
    {
        ...
        {
            if (std::find_if(extensions.begin(), extensions.end(), [=](vk::ExtensionProperties& ext)
            {
    ...
    static bool isDeviceSuitable(vk::PhysicalDevice device, vk::SurfaceKHR surface)
    {
        ...
        bool indicesComplete = indices.graphics.has_value() && indices.present.has_value();
    ...
    std::optional<std::pair<vk::Device, QueueFamilyIndices>> createDevice(vk::PhysicalDevice physicalDevice, vk::SurfaceKHR surface) {
        ...
        auto end = std::unique(uniqueQueueFamilies.begin(), uniqueQueueFamilies.end());

...
namespace g2::gfx
{
    ...
    static vk::Extent2D chooseSwapExtent(const vk::SurfaceCapabilitiesKHR& capabilities, vk::Extent2D windowExtent)
    {
    ...
    static std::optional<vkSwapChain> createVKSwapChain(vk::Device device, vk::PhysicalDevice physicalDevice, vk::SurfaceKHR surface, vk::Extent2D windowExtent, QueueFamilyIndices familyIndices)
    {
        ...
        {
            uint32_t indices[] = { familyIndices.graphics.value(), familyIndices.present.value() };
    ...
    static std::vector<vk::ImageView> createImageViews(vk::Device device, const std::vector<vk::Image>& images, vk::Format format)
    {
